...
namespace HumanResourcesDepartment.WPF.ViewModels
{
    ...
    {
        public ICommand CreateWorkerCommand { get; private set; }
        ...
        public CreateWorkerViewModel(GenericDataService<Worker> workerService, MainWindowViewModel mainWindowViewModel)
        {
            CreateWorkerCommand = new CreateWorkerCommand(this, workerService);
        }
    }
}
